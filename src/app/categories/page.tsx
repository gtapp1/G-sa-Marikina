      ...
      <div className="mt-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
        {categories.map((cat) => (
          <Link
            ...
            className="group flex flex-col items-center justify-center gap-2 p-6 rounded-[var(--radius-md)] bg-[var(--color-surface)] border border-[var(--color-border)] hover:border-[var(--color-primary)] hover:shadow-[0_4px_12px_rgba(61,44,30,0.12)] transition-all"
          >
